...
# `event["harness"]`, never `args`. See the shared `agenttools_hatch_escalation.EXEMPT_HARNESSES`
# allowlist (orchestrator-stays-thin was the first consumer, agent-tools#533; #542 made it shared).
HARNESS = "claude-code"
