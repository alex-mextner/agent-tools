...
MESSAGE = (
    ...
    "`gh ship <PR#>`, alone on the line, is the one sanctioned exception, agent-tools#159/#363; add "
    "`--repo <owner/repo>` to that SAME unchained command to ship a PR that lives in a different "
    "repo than this checkout — never `cd <repo> && gh ship <PR#>`, which chains and loses the "
    "exception). "
